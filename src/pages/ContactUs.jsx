    ...
    <>
      ...
      <div className="pt-[3rem]">
        <div className="wrapper">
          <div className="grid sm:grid-cols-2 gap-5 max-w-2xl mx-auto mb-[3rem]">
            <div
              data-aos="fade-up"
              className="bg-primary/5 flex flex-col gap-3 items-center justify-center rounded-xl p-5"
            >
              <MapPin
                strokeWidth={2}
                size={40}
